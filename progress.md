...
| 11 EventAI | p0_junit | Gherkin Garrick **103** spell **7164** (`TP-SL11-001`); EventAI: 500 ms window, chance/phase/flags, TIMER_IN_COMBAT/OOC/GENERIC, HP/MANA/TARGET_HP/MANA, AURA/MISSING_AURA, SPELLHIT Fireball **133**, CAST flags/invoker, SET_FACTION/THREAT/DIE/RANDOM_PHASE/UNIT_FLAG. In-memory `load(scripts)` only. **Not `p0_client`.** |
