...
public final class SpellEngine {
    ...
    private static final Set<Integer> KNOWN_EFFECTS = Set.of(
            ...
            EFFECT_PERSISTENT_AREA_AURA, EFFECT_REDIRECT_THREAT, EFFECT_LANGUAGE, EFFECT_DODGE,
    ...
    /** CMaNGOS EffectEmpty — marker / client inform; no server mutation. */
    private static final Set<Integer> EMPTY_EFFECTS = Set.of(EFFECT_LANGUAGE, EFFECT_DODGE);
