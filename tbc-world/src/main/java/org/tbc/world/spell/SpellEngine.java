...
public final class SpellEngine {
    ...
    private static final Set<Integer> KNOWN_EFFECTS = Set.of(
            ...
            EFFECT_PERSISTENT_AREA_AURA, EFFECT_REDIRECT_THREAT, EFFECT_LANGUAGE, EFFECT_DODGE, EFFECT_TRADE_SKILL, EFFECT_SKILL,
     ...
     * TRADE_SKILL / SKILL: profession skill comes from the SKILL_STEP learn spell, not these effects.
     */
    private static final Set<Integer> EMPTY_EFFECTS = Set.of(
            EFFECT_LANGUAGE, EFFECT_DODGE, EFFECT_TRADE_SKILL, EFFECT_SKILL);
