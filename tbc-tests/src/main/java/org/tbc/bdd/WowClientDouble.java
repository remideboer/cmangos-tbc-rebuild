...
public final class WowClientDouble implements PacketSink {
    ...
    public void addIgnore(World world, String name) {
        WowBuffer b = new WowBuffer(32);
        b.putCString(name);
    ...
    public void setContactNotes(World world, long guid, String note) {
        WowBuffer b = new WowBuffer(8 + note.length() + 1);
        b.putU64(guid);
        b.putCString(note);
        handle(world, Opcodes.CMSG_SET_CONTACT_NOTES, b.array());
    }
    ...
    public void takeMailMoney(World world, long mailbox, int mailId) {
        WowBuffer b = new WowBuffer(12);
        b.putU64(mailbox);
        b.putU32(mailId);
    ...
    public void queryNextMailTime(World world) {
        handle(world, Opcodes.MSG_QUERY_NEXT_MAIL_TIME, new byte[0]);
    }

    public void createMailTextItem(World world, long mailbox, int mailId) {
        WowBuffer b = new WowBuffer(16);
        b.putU64(mailbox);
        b.putU32(mailId);
        b.putU32(0);
        handle(world, Opcodes.CMSG_MAIL_CREATE_TEXT_ITEM, b.array());
    }
    ...
    public void markMailRead(World world, long mailbox, int mailId) {
        ...
        b.putU64(mailbox);
        b.putU32(mailId);
        handle(world, Opcodes.CMSG_MAIL_MARK_AS_READ, b.array());
    }

    public void deleteMail(World world, long mailbox, int mailId) {
        WowBuffer b = new WowBuffer(16);
        b.putU64(mailbox);
        b.putU32(mailId);
        b.putU32(0);
        handle(world, Opcodes.CMSG_MAIL_DELETE, b.array());
    }
