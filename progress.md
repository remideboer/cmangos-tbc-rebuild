...
| 11 EventAI | p0_junit | Gherkin Garrick **103** spell **7164** (`TP-SL11-001`); EventAI interpreter: 500 ms window, chance/phase/flags, TIMER_IN_COMBAT/OOC, HP, DEATH/EVADE/SPAWNED/REACHED_HOME, CAST 0/1, SET/INC_PHASE, EVADE. In-memory `load(scripts)` only (not ACID SQL). **Not `p0_client`.** |
