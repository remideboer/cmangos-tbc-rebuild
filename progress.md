...
| 12 Combat math | p0_junit | `MeleeTableTest` 5% miss/dodge/parry/block; no glance L1 vs L1; player vs NPC>10 glance 10+(defense−skill) and low/high-end damage; sitting player remaining table is crit; player/creature crit 2×; NPC crush 150% when skill deficit ≥ 15; `hitInfo` CRITICALHIT / CRUSHING |
