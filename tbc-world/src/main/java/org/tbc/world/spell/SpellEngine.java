...
public final class SpellEngine {
    ...
    private static final Set<Integer> KNOWN_EFFECTS = Set.of(
            ...
            EFFECT_PERSISTENT_AREA_AURA, EFFECT_REDIRECT_THREAT, EFFECT_LANGUAGE, EFFECT_DODGE, EFFECT_TRADE_SKILL, EFFECT_SKILL, EFFECT_WEAPON, EFFECT_DEFENSE, EFFECT_EVADE, EFFECT_CALL_PET, EFFECT_PULL,
    ...
    private static final Set<Integer> NO_OP_EFFECTS = Set.of(
            ...
            EFFECT_EVADE, EFFECT_CALL_PET, EFFECT_PULL);
