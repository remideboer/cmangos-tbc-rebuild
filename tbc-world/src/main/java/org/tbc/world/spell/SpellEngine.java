...
public final class SpellEngine {
    ...
    private static final Set<Integer> KNOWN_EFFECTS = Set.of(
            ...
            EFFECT_PERSISTENT_AREA_AURA, EFFECT_REDIRECT_THREAT, EFFECT_LANGUAGE, EFFECT_DODGE, EFFECT_TRADE_SKILL, EFFECT_SKILL, EFFECT_WEAPON,
     ...
     * TRADE_SKILL / SKILL / WEAPON: the skill line owns the value, not these effects.
     */
    private static final Set<Integer> EMPTY_EFFECTS = Set.of(
            EFFECT_LANGUAGE, EFFECT_DODGE, EFFECT_TRADE_SKILL, EFFECT_SKILL, EFFECT_WEAPON);
